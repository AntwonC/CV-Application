...
const EducationInformation = (props) => {
  ...
  return (
    <div id="education-container">
      ...
      <input type="text" id="school" name="schoolInput" disabled={disabled} onChange={props.inputChange} />
      <label htmlFor="major" id="label-major">Field of Study</label>
      <input type="text" id="major" name="majorInput" disabled={disabled} onChange={props.inputChange} />
      <label htmlFor="degree" id="label-degree">Degree</label>
      <input type="text" id="degree" name="degreeInput" disabled={disabled} onChange={props.inputChange} />
      <label htmlFor="date" id="label-date">Date Finished</label>
      <input type="text" id="date" name="dateOfStudyInput" disabled={disabled} onChange={props.inputChange} />
